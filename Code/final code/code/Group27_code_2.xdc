...
set_property PACKAGE_PIN T18 [get_ports keep_running_pb]
   set_property IOSTANDARD LVCMOS33 [get_ports keep_running_pb]
...
# Sch name = JA4
 set_property PACKAGE_PIN G2 [get_ports {conveyor_echo}]
    set_property IOSTANDARD LVCMOS33 [get_ports {conveyor_echo}]
# Sch name = JA7
...
set_property PACKAGE_PIN G3 [get_ports {conveyor_trig}]
   set_property IOSTANDARD LVCMOS33 [get_ports {conveyor_trig}]
